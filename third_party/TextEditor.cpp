...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Rhythm()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		static const char* const keywords[] = {
			"and", "break", "", "else", "false", "for", "fun", "if",  "", "var", "nil", "not", "or",  "return", "then", "true",  "while"
		};
		...
		static const char* const identifiers[] = {
			"assert", "clock", "push", "pop", "for_each"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
